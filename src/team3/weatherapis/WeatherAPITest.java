...
//
//
		DbManager city = new DbManager();
		city.setCityToApis("Paris");

//		System.out.println(riga.getApiWb().toString());
//
		
		System.out.println(city.getApiAris().toString());
...
//		// weatherbit.io
//		weatherApis.add(new WeatherAPIWB("Riga"));
//
//		weatherApis.add(new WeatherAPIDarkSky());

//		new WeatherAPIWB("Riga");
